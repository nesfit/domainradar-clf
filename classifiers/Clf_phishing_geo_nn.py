"""
Geolocation-based Phishing domain classifier using a deep neural network.
"""
...
class Clf_phishing_geo_nn:
    """
        Class for the Geolocation-based deep NN phishing domain classifier.
    ...
    def __init__(self, options: PipelineOptions):
        ...
        # Load the NN model
        self.model = load_model(os.path.join(options.models_dir, 'phishing_geo_nn_model.keras'))

        # Load the scaler
        self.scaler = joblib.load(os.path.join(options.boundaries_dir, 'phishing_geo_nn_scaler.joblib'))
