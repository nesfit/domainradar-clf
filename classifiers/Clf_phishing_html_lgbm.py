...
Classifies phishing domains using LightGBM model ased on HTML-based features.
"""
...
class Clf_phishing_html_lgbm:
    """
        Class for the HTML-based LightGBM phishing classifier.
    ...
    def __init__(self, options: PipelineOptions):
        ...
        self.model = joblib.load(os.path.join(options.models_dir, 'phishing_html_lgbm_model.joblib'))
